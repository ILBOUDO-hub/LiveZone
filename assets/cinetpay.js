CinetPay = new (class {
  ...
  async setConfig(e = this.config) {
    if ("object" != typeof e || void 0 === e)
      return (
        ...
        void (this.error.description = "Set an object in your setConfig method")
      );
    (this.config = e),
  ...
  displayButton() {
    if ("WEB" === this.type && null == document.getElementById("cp-close")) {
      let e = document.getElementById("modal_first_parent_content_wrapper"),
  ...
  async getCheckout(e) {
      ...
      );
    {
      ...
      "MOBILE" === this.type &&
        (l +=
          ".cp-modal .cp-content-wrapper {width: 100% !important;height: 100% !important;}"),
        (o.innerHTML = l),
        p.appendChild(i),
        i.appendChild(c),
        c.appendChild(n),
        ...
        if (
          ...
          (t.onprogress = function (e) {}),
            (t.onreadystatechange = function (e) {
              let p = void 0 !== XMLHttpRequest.DONE ? XMLHttpRequest.DONE : 4;
              if (t.readyState === p && 200 === t.status) {
                let e = t.response;
                if (202 !== e.code)
                  return (
                    (this.error.message = e.message),
                    void (this.error.description = "An error occurred")
                  );
            ...
            (t.responseType = "json");
          let p = { old_device_id: this.old_socket_id, new_device_id: e.id };
          ...
          (t.onreadystatechange = function (e) {
            ...
            if (t.readyState === p && 200 === t.status) {
              ...
              if ("201" !== e.code)
                return (
                  (this.error.message = e.message),
                  void (this.error.description = e.description)
                );
              {
                let t = e.data;
                (this.checkout = t.payment_url), this.openCheckout();
              }
            } else if (t.readyState === p && 200 !== t.status)
              return (
                (this.error.message = t.response.message),
                void (this.error.description = t.response.description)
              );
          }.bind(this)),
          (t.onload = function (e) {}),
          (t.onerror = function (e) {}),
  ...
  async initCheckout() {
    if (window.navigator.onLine) {
      ...
      (document.getElementById("cp_modal_first_parent").style.pointerEvents =
        "none"),
        "WEB" === this.type &&
          setTimeout(() => {
            (document.getElementById("cp_modal_first_parent").style.display =
              "none"),
